function FFF_Time_in_minutes_and_Data_Selected_Detectors = ZZ_FFF_Guo2013_UWM_Read_Selected_Detectors_UV_1_UV_2_FLD1_FLD2(filename)
...
fid_pure_data_raw = fopen('C:\Matlab Processing\FUNCTIONZHOU\Pure_FFF_data_raw.dat','wt');
...
Pure_Data = load('C:\Matlab Processing\FUNCTIONZHOU\Pure_FFF_data_raw.dat');
