...
fnames = fopen(strcat(WorkingPath,'FileNames_PSS_Standards_for_Calibration_of_D_to_MW.txt'),'r');counter_names = 0;while 1;line = fgetl(fnames);eof = feof(fnames);counter_names = counter_names + 1;if eof ==1;break;end;end;fclose(fnames);
...
%     save FFF_Measurement_time.dat FFF_Measurement_time -ascii -tabs;
    ...
    xlabel('Retention Time (s)','fontname','times','fontsize',x_y_fontsize);ylabel('Voltage','fontname','times','fontsize',x_y_fontsize);title(samplename,'interpreter','none','fontname','times','fontsize',x_y_fontsize);
    ...
    xlabel('Hydrodynamic Diameter (nm)','fontname','times','fontsize',x_y_fontsize);ylabel('Voltage','fontname','times','fontsize',x_y_fontsize);title(samplename,'interpreter','none','fontname','times','fontsize',x_y_fontsize);
    legend(Detectors_want_to_plot_modified_names,'fontname','times','fontsize',legend_fontsize);
    set(gca,'fontname','times','fontsize',gca_fontsize);
    ...
    xlabel('Molecular Weight (Da)','fontname','times','fontsize',x_y_fontsize);ylabel('Voltage','fontname','times','fontsize',x_y_fontsize);title(samplename,'interpreter','none','fontname','times','fontsize',x_y_fontsize);
    legend(Detectors_want_to_plot_modified_names,'fontname','times','fontsize',legend_fontsize);
    set(gca,'fontname','times','fontsize',gca_fontsize);
    ...
    xlabel('Diffusion Coefficient(m^2/s)','fontname','times','fontsize',x_y_fontsize);ylabel('Voltage','fontname','times','fontsize',x_y_fontsize);title(samplename,'interpreter','none','fontname','times','fontsize',x_y_fontsize);
    legend(Detectors_want_to_plot_modified_names,'fontname','times','fontsize',legend_fontsize);
    set(gca,'fontname','times','fontsize',gca_fontsize);
