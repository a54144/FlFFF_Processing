    ...
    methods(Access = private)
        function createGraphics( this )
            ...
            if ~this.Created
                ...
                this.HCurvePlot.Color = sftoolgui.util.LightTheme.Blue;
        ...
        function callPlotDataLineWithExclusions( this )
            ...
            previewValues =  sftoolgui.util.previewValues( aFitdev.FittingData );
            if areNumSpecifiedElementsEqual( aFitdev.FittingData )
                this.plotDataLineWithExclusions( ...
                    previewValues, aFitdev.Exclusions, aFitdev.FittingData.Name );
            end
        end
