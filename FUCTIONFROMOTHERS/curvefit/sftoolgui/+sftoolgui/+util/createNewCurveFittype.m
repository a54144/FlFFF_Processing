function [ ft, fopts, customEquation, errorStr ] = createNewCurveFittype( fitTypeName, qualifier, optionNameValuePairs, startpoint, lower, upper, ind, dep)
% createNewCurveFittype creates a curve fittype and options.

%   Copyright 2010-2011 The MathWorks, Inc.
%   $Revision: 1.1.6.5 $    $Date: 2012/08/20 23:57:30 $
errorStr = '';
customEquation = '';
