...
function iGenerateCodeForPlots(this,mcode)
    ...
    switch nPlots
        ...
        case 2
            addBlankLine( mcode );
            addFitComment( mcode, getString(message('curvefit:sftoolgui:CreateAFigureForThePlots')) );
...
if ~isCurve( aFitdev ) && isValidationDataValid( aFitdev )
    ...
    addBlankLine( mcode );
    addFitComment( mcode, getString(message('curvefit:sftoolgui:ComputeLimitsForAxes')) );
