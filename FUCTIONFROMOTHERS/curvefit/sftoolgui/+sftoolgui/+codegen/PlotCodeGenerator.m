classdef PlotCodeGenerator < curvefit.Handle
    ...
    methods(Access = private)
        ...
        function addValidationPlotBlock( obj, mcode )
            ...
            if obj.HaveValidation
                addFitComment( mcode, getString(message('curvefit:sftoolgui:AddValidationDataToPlot')) );
    ...
    methods(Access = protected)
        function addAxesLabels( ~, mcode )
            ...
            addFunctionCall( mcode, 'xlabel', '''<x-name>''' );
            addFunctionCall( mcode, 'ylabel', '''<y-name>''' );
            addFunctionCall( mcode, 'zlabel', '''<z-name>''' );
        end
