...
%   $Revision: 1.10.2.16 $  $Date: 2012/08/20 23:55:37 $
...
switch flag
    case 1
        msg = getString(message('curvefit:curvefit:FittingConvergedToASolution'));
    case 2
        msg = getString(message('curvefit:curvefit:FittingStoppedBecauseChangeInCoefficientsLessThanTolX'));
    case 3
        msg = getString(message('curvefit:curvefit:FittingStoppedBecauseChangeInResidualsLessThanTolFun'));
    case 4
        msg = getString(message('curvefit:curvefit:FittingStoppedBecauseMagnitudeOfSearchDirection'));
    case 0
        msg = getString(message('curvefit:curvefit:FittingStoppedBecauseMaxIterOrMaxFunEvalExceeded'));
    case -1
        msg = getString(message('curvefit:curvefit:FittingStoppedByUser'));
    case -2
        msg = getString(message('curvefit:curvefit:FitNotComputedBecauseLowerBoundsAreGreaterThanUpperBounds'));
    case -4
        msg = getString(message('curvefit:curvefit:FittingCouldNotMakeFurtherProgress'));
    otherwise
        % We should not hit this case.
        msg = getString(message('curvefit:curvefit:FittingStoppedForUnknownReason'));
