...
%   $Revision: 1.1.6.3 $    $Date: 2012/08/20 23:54:26 $ 
...
if graphicsversion(aGraphic, 'handlegraphics')
    aGraphic = handle( aGraphic );
    schema.prop( aGraphic, propertyName, 'MATLAB array' );
else
