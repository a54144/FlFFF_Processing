...
hand.add_item = uimenu(h1,'Label',getString(message('SPLINES:resources:menu_Add')), ...
    'Callback', 'splinetool ''add_item''', ...
    'Tag','add_item');
hand.rep_knot = uimenu(h1,'Label',getString(message('SPLINES:resources:menu_ReplicateKnot')), ...
    'Callback','splinetool ''rep_knot''','Tag','rep_knot');
hand.del_item = uimenu(h1,'Label',getString(message('SPLINES:resources:menu_Delete')), ...
...
upperXLim = findprop(handle(hand.Axes(1)),'XLim');
hand.XLimListener = handle.listener(hand.Axes(1), upperXLim, 'PropertyPostSet', setXLim);
end
